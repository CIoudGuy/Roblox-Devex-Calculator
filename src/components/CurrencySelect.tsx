...
export default function CurrencySelect({ value, onValueChange }: CurrencySelectProps) {
  const current = currencyList.find((currency) => currency.code === value) || currencyList[0];
